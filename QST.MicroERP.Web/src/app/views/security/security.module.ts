...
@NgModule({
  ...
  declarations: [ManageRoleComponent, ManageUserComponent, CreateUserDialogComponent, AssignRoleToUserComponent, CreateUserRoleComponent, LoginComponent, ManagePermissionsComponent],
  providers: [
    DatePipe,
