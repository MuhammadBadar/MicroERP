...
DisabledType: boolean = false;
  ...
  assignClass?: AssignClassVM[]
    ...
    ngOnInit(): void {
      ...
      // this.GetSettings(EnumTypes.Class)
      // this.GetSettings(EnumTypes.Section)
      // this.GetSettings(EnumTypes.Branch)
      this.Add = true;
