...
@Component({
  selector: 'app-configure-product-attrib',
  templateUrl: './configure-product-attrib.component.html',
  styleUrls: ['./configure-product-attrib.component.css']
})
export class ConfigureProductAttribComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<ConfigureProductAttribComponent>,
