...
@Component({
  selector: 'app-configure-bar-code',
  templateUrl: './configure-bar-code.component.html',
  styleUrls: ['./configure-bar-code.component.css']
})
export class ConfigureBarCodeComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<ConfigureBarCodeComponent>,
