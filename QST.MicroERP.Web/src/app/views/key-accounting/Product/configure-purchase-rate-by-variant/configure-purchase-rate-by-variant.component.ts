...
@Component({
  selector: 'app-configure-purchase-rate-by-variant',
  templateUrl: './configure-purchase-rate-by-variant.component.html',
  styleUrls: ['./configure-purchase-rate-by-variant.component.css']
})
export class ConfigurePurchaseRateByVariantComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<ConfigurePurchaseRateByVariantComponent>,
