...
@Component({
  selector: 'app-patient-field-list',
  templateUrl: './patient-field-list.component.html',
  styleUrls: ['./patient-field-list.component.css'],
...
export class PatientFieldListComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.isReadOnly = this.catSvc.getPermission(RouteIds.PatientParameters)
  ...
  OpenDialog() {
    debugger
    this.dialogRef = this.dialog.open(PatientFieldsComponent, {
  ...
  GetSettingsType() {
    ...
    type.parentId = EnumTypes.PatientFields
