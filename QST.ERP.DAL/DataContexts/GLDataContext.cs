...
{
    public class PQSDataContext : DbContext , IDbContext
    {
        public PQSDataContext(string nameOrConString) : base(nameOrConString) { }

        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            var typesToRegister = Assembly.GetAssembly(typeof(DAL)).GetTypes()
           .Where(type => !String.IsNullOrEmpty(type.Namespace) && type.Namespace == "QST.ERP.DAL.Maps.QST")
