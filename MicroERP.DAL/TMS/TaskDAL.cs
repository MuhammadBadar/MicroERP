    ...
    public class TaskDAL
    {
        ...
        public List<AttachmentsDE> SearchAttachments(string whereClause, MySqlCommand cmd = null)
        {
            ...
            try
            {
                ...
                top = cmd.Connection.Query<AttachmentsDE>("call MicroERP.SearchAttachments( '" + whereClause + "'  ) ").ToList();
                return top;
            }
            catch (Exception)
            {
        ...
        public SearchResult SearchTasks(string whereClause, string retType, MySqlCommand cmd = null)
        {
            ...
            try
            {
                ...
                {
                    result.Tasks = cmd.Connection.Query<TaskDE>("call MicroERP.SearchTask( '" + whereClause + "'  ) ").ToList();
                    return result;
                }
                else
                {
                    result.UserTasks = cmd.Connection.Query<UserTaskVM>("call MicroERP.SearchTask( '" + whereClause + "'  ) ").ToList();
                    return result;
                }
            }
            catch (Exception)
