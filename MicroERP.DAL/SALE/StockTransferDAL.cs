        ...
        public List<StockTransferDE> SearchStockTransfers(string whereClause, MySqlCommand cmd = null)
        {
            ...
            try
            {
                ...
                if (cmd.Connection.State == ConnectionState.Open)
                    ...
                    Console.WriteLine("Connection error");
                top = cmd.Connection.Query<StockTransferDE>("call MicroERP.SearchStockTransfer( '" + whereClause + "')").ToList();
                return top;
            }
            catch (Exception exp)
            {
        ...
        public List<StockTransferLineDE> SearchStockTransferLine(string whereClause, MySqlCommand cmd = null)
        {
            ...
            try
            {
                ...
                if (cmd.Connection.State == ConnectionState.Open)
                    ...
                    Console.WriteLine("Connection error");
                top = cmd.Connection.Query<StockTransferLineDE>("call MicroERP.SearchSTLine( '" + whereClause + "')").ToList();
                return top;
            }
            catch (Exception exp)
            {
