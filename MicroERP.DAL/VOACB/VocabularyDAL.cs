    ...
    public class VocabularyDAL
    {
        ...
        public List<VocabularyDE> SearchVocabulary(string WhereClause, MySqlCommand cmd)
        {
            ...
            try
            {
                ...
                lec = cmd.Connection.Query<VocabularyDE>("call MicroERP.SearchVocabulary('" + WhereClause + "')").ToList();
                return lec;
            }
            catch (Exception)
            {
        ...
        public List<UserVocabularyDE> SearchUserVocabulary(string WhereClause, MySqlCommand cmd)
        {
            ...
            try
            {
                ...
                userVocabularies = cmd.Connection.Query<UserVocabularyDE>("call MicroERP.SearchUserVocabulary('" + WhereClause + "')").ToList();
