        ...
        public List<ScheduleDE> SearchSchedule(string whereClause, MySqlCommand cmd = null)
        {
            ...
            try
            {
                ...
                if (cmd.Connection.State == ConnectionState.Open)
                    ...
                    Console.WriteLine("Connection error");
                top = cmd.Connection.Query<ScheduleDE>("call MicroERP.SearchSchedule( '" + whereClause + "')").ToList();
                return top;
            }
            catch (Exception)
            {
        ...
        public List<ScheduleDayEventDE> SearchScheduleDayEvent(string whereClause, MySqlCommand cmd = null)
        {
            ...
            try
            {
                ...
                if (cmd.Connection.State == ConnectionState.Open)
                    ...
                    Console.WriteLine("Connection error");
                top = cmd.Connection.Query<ScheduleDayEventDE>("call MicroERP.SearchScheduleDayEvent( '" + whereClause + "')").ToList();
                return top;
            }
            catch (Exception)
            {
        ...
        public List<ScheduleDayDE> SearchScheduleDay(string whereClause, MySqlCommand cmd = null)
        {
            ...
            try
            {
                ...
                if (cmd.Connection.State == ConnectionState.Open)
                    ...
                    Console.WriteLine("Connection error");
                top = cmd.Connection.Query<ScheduleDayDE>("call MicroERP.SearchScheduleDay( '" + whereClause + "')").ToList();
                return top;
            }
            catch (Exception)
            {
